...
//        private final String ImageExternalCatchDir = App.get().getExternalCacheDir() + "/image_cache";

        public static ImageCatchUtil get() {
            if (inst == null) {
...
//            清除图片内存缓存
     ...
     /*   *//**
        ...
        public String getCacheSize() {
            try {
                return getFormatSize(getFolderSize(new File(App.get().getCacheDir() + "/image_cache")));
            } catch (Exception e) {
                e.printStackTrace();
            }
            return "";
